...
import {
  ...
  useFormControl
} from "./chunk-7BM44Y77.js";
import {
  init_useEnhancedEffect,
  useEnhancedEffect_default as useEnhancedEffect_default2
} from "./chunk-M7QHUK6M.js";
import {
  init_useForkRef,
  useForkRef_default
} from "./chunk-WTQ6YRXH.js";
import {
  capitalize_default,
  init_capitalize
} from "./chunk-MWN6DQZ5.js";
import {
  GlobalStyles_default
} from "./chunk-HBPMCOYT.js";
import {
  HTMLElementType,
  chainPropTypes,
...
var COMPONENT_NAME11 = "Popper";
function getPopperUtilityClass(slot) {
  return generateUtilityClass2(COMPONENT_NAME11, slot);
}
var popperClasses = generateUtilityClasses2(COMPONENT_NAME11, ["root"]);
...
var sliderClasses = generateUtilityClasses2(COMPONENT_NAME12, ["root", "active", "focusVisible", "disabled", "dragging", "marked", "vertical", "trackInverted", "trackFalse", "rail", "track", "mark", "markActive", "markLabel", "markLabelActive", "thumb"]);
...
function useSlider(parameters) {
  ...
  const touchId = React29.useRef();
  const [active, setActive] = React29.useState(-1);
  const [open, setOpen] = React29.useState(-1);
  const [dragging, setDragging] = React29.useState(false);
  const moveCount = React29.useRef(0);
  ...
  const [focusedThumbIndex, setFocusedThumbIndex] = React29.useState(-1);
  const sliderRef = React29.useRef();
  ...
  const previousIndex = React29.useRef();
  ...
  const stopListening = React29.useCallback(() => {
    const doc = ownerDocument(sliderRef.current);
...
var Slider = React30.forwardRef(function Slider2(props, forwardedRef) {
...
var snackbarClasses = generateUtilityClasses2(COMPONENT_NAME13, ["root"]);
...
function useSnackbar(parameters = {}) {
  ...
  const handleResume = React31.useCallback(() => {
...
var Snackbar = React32.forwardRef(function Snackbar2(props, forwardedRef) {
  const {
    autoHideDuration = null,
    children,
    disableWindowBlurListener = false,
...
var switchClasses = generateUtilityClasses2(COMPONENT_NAME14, ["root", "input", "track", "thumb", "checked", "disabled", "focusVisible", "readOnly"]);
...
var Switch = React34.forwardRef(function Switch2(props, forwardedRef) {
...
var TablePaginationActions = React35.forwardRef(function TablePaginationActions2(props, forwardedRef) {
...
var tablePaginationClasses = generateUtilityClasses2(COMPONENT_NAME15, ["root", "toolbar", "spacer", "selectLabel", "selectRoot", "select", "selectIcon", "input", "menuItem", "displayedRows", "actions"]);
...
var TablePagination = React36.forwardRef(function TablePagination2(props, forwardedRef) {
...
var tabPanelClasses = generateUtilityClasses2(COMPONENT_NAME16, ["root", "hidden"]);
...
var tabsClasses = generateUtilityClasses2(COMPONENT_NAME17, ["root", "horizontal", "vertical"]);
...
function useTabs(parameters) {
  ...
  const onSelected = React37.useCallback((event, newValue) => {
    setValue(newValue);
  ...
  const tabIdLookup = React37.useRef(() => void 0);
  const getTabPanelId = React37.useCallback((tabValue) => {
    var _tabPanels$get;
    return (_tabPanels$get = tabPanels.get(tabValue)) == null ? void 0 : _tabPanels$get.id;
  }, [tabPanels]);
  const getTabId = React37.useCallback((tabPanelId) => {
    return tabIdLookup.current(tabPanelId);
  }, []);
  const registerTabIdLookup = React37.useCallback((lookupFunction) => {
...
function useTabsContext() {
  const context = React38.useContext(TabsContext);
  if (context == null) {
...
var Tabs = React40.forwardRef(function Tabs2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    orientation = "horizontal",
...
function useTabPanel(parameters) {
  ...
  const metadata = React41.useMemo(() => ({
    id,
    ref
  }), [id]);
  const {
...
var TabPanel = React42.forwardRef(function TabPanel2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var tabsListClasses = generateUtilityClasses2(COMPONENT_NAME18, ["root", "horizontal", "vertical"]);
...
function useTabsList(parameters) {
  ...
  const tabIdLookup = React43.useCallback((tabValue) => {
    var _subitems$get;
    return (_subitems$get = subitems.get(tabValue)) == null ? void 0 : _subitems$get.id;
  }, [subitems]);
  registerTabIdLookup(tabIdLookup);
  const subitemKeys = React43.useMemo(() => Array.from(subitems.keys()), [subitems]);
  const getTabElement = React43.useCallback((tabValue) => {
  ...
  const handleChange = React43.useCallback((event, newValue) => {
    var _newValue$;
    onSelected(event, (_newValue$ = newValue[0]) != null ? _newValue$ : null);
  }, [onSelected]);
  const controlledProps = React43.useMemo(() => {
    if (value === void 0) {
      return {};
    }
    return value != null ? {
  ...
  const isItemDisabled = React43.useCallback((item) => {
  ...
  const contextValue = React43.useMemo(() => _extends({}, compoundComponentContextValue, listContextValue), [compoundComponentContextValue, listContextValue]);
  return {
    contextValue,
    dispatch,
    getRootProps,
...
var TabsList = React45.forwardRef(function TabsList2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    slotProps = {},
...
var tabClasses = generateUtilityClasses2(COMPONENT_NAME19, ["root", "selected", "disabled"]);
...
function useTab(parameters) {
  ...
  const tabRef = React46.useRef(null);
  const id = useId(idParam);
  const {
    value: selectedValue,
    selectionFollowsFocus,
...
var Tab = React47.forwardRef(function Tab2(props, forwardedRef) {
  var _slots$root;
  const {
    children,
    disabled = false,
...
var TextareaAutosize = React48.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime40.jsxs)(React48.Fragment, {
...
function useAutocomplete(props) {
  ...
  const ignoreFocus = React49.useRef(false);
  const firstFocus = React49.useRef(true);
  const inputRef = React49.useRef(null);
  const listboxRef = React49.useRef(null);
  const [anchorEl, setAnchorEl] = React49.useState(null);
  const [focusedTag, setFocusedTag] = React49.useState(-1);
  const defaultHighlighted = autoHighlight ? 0 : -1;
  const highlightedIndexRef = React49.useRef(defaultHighlighted);
  ...
  const resetInputValue = React49.useCallback((event, newValue) => {
  ...
  const [inputPristine, setInputPristine] = React49.useState(true);
  ...
  const syncHighlightedIndex = React49.useCallback(() => {
    if (!popupOpen) {
      return;
    }
  ...
  const isTouch = React49.useRef(false);
  ...
  return (0, import_jsx_runtime43.jsxs)(React51.Fragment, {
    children: [!disableInjectingGlobalStyles && inputGlobalStyles, (0, import_jsx_runtime43.jsxs)(Root, _extends({}, rootProps, !isHostComponent(Root) && {
      ...
      children: [startAdornment, (0, import_jsx_runtime42.jsx)(FormControlContext_default.Provider, {
        value: null,
        children: (0, import_jsx_runtime42.jsx)(Input3, _extends({
          ownerState,
...
var OutlinedInput = React52.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime45.jsx)(InputBase_default, _extends({
    ...
    renderSuffix: (state) => (0, import_jsx_runtime45.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime44.jsxs)(React52.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
@mui/base/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-C5RGG7F5.js.map
